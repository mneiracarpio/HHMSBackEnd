...
import com.hhms.filter.JwtRequestFilter;
...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
  ...
  protected void configure(HttpSecurity http) throws Exception {
    http
        ...
        .antMatchers("/v1/manager/**").hasAnyRole("MANAGER","SUPERVISOR")
        //.antMatchers("/v1/employee/**").hasAnyRole("HOUSEKEEPING","LAUNDRY","JANITORIAL")
        .antMatchers("/v1/employee/**").permitAll()
